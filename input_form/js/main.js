function convert(){
    ...
    //getting values from the local storage + transform them to integers
    var moneyEarned = parseInt(localStorage.getItem("iMoneyEarned"));
    var moneyRemaining = parseInt(localStorage.getItem("iMoneyRemaining"));
    var freeTime = parseInt(localStorage.getItem("iFreeTime"));
    var paraEarning = parseInt(localStorage.getItem("iParaEarning"));
    var paraTime = parseInt(localStorage.getItem("iParaTime"));
    var paraSaving = parseInt(localStorage.getItem("iParaSaving"));
